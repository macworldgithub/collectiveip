      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                <Icon
                  size={22}
                  className={`mb-4 ${
                    active ? "text-[#c084fc]" : "text-white/60"
                  }`}
                />
          ...
          <>
            <div className="mt-6">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="h-12 sm:h-14 w-full rounded-2xl border border-white/10 bg-[#0b0d14] pl-11 pr-4 text-sm outline-none transition focus:border-[#5A2680]"
                />
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 2xl:grid-cols-3">
              {filteredProperties.map((property) => (
                <div
                  key={property.id}
                  className="overflow-hidden rounded-3xl border border-white/10 bg-[#0b0d14] transition hover:-translate-y-1 hover:border-[#5A2680]/40"
                >
                  <div className="relative h-[220px] sm:h-[260px] overflow-hidden">
                    ...
                    <div className="absolute left-3 top-3 rounded-full bg-[#5A2680] px-3 py-1 text-[10px] sm:text-xs font-bold">
                      {property.badge}
                    </div>

                    <button className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-black/40 backdrop-blur-md">
                      <Heart size={16} />
                    </button>

                    <div className="absolute bottom-3 right-3 rounded-full bg-black/60 px-3 py-1 text-xs sm:text-sm font-bold text-[#d8b4fe]">
                      {property.match}
                    </div>
                  </div>
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="mt-3 flex items-start gap-2 text-sm text-white/80">
                      <MapPin
                        size={16}
                        className="mt-[2px] shrink-0 text-white/40"
                      />
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {property.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-1 text-[11px] sm:text-xs text-white/60"
                        >
                          {tag}
                        </span>
                      ))}
        ...
        {activeTab === "valuation" && (
          <div className="mt-6 space-y-6">
            {!valuationResult ? (
              <>
                <div className="rounded-3xl border border-white/10 bg-[#0b0d14] p-5 sm:p-8">
                  <h2 className="text-2xl font-bold">
                    AI PROPERTY VALUATION
                  </h2>

                  <p className="mt-2 text-sm sm:text-base text-white/60">
                    Enter any London address and receive an AI-powered instant
                    valuation.
                  </p>
                  ...
                  <div className="mt-6 flex flex-col gap-4 lg:flex-row">
                    <input
                      ...
                      value={valuationAddress}
                      onChange={(e) =>
                        setValuationAddress(e.target.value)
                      }
                      placeholder="Enter property address..."
                      className="h-12 sm:h-14 flex-1 rounded-2xl border border-white/10 bg-[#05060b] px-4 outline-none focus:border-[#5A2680]"
                    />
                    ...
                    <button
                      ...
                      disabled={!valuationAddress || valuationLoading}
                      className="flex h-12 sm:h-14 items-center justify-center gap-2 rounded-2xl bg-[#5A2680] px-6 text-sm font-bold transition hover:bg-[#6b2f97] disabled:opacity-50"
                    >
                      {valuationLoading ? (
                        <Loader
                          size={18}
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {quickSelectAddresses.map((address, index) => (
                      <button
                        key={index}
                        onClick={() => handleValuation(address)}
                        className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs sm:text-sm text-white/70 transition hover:bg-white/10"
                      >
                        {address}
                      </button>
                    ))}
                ...
                {valuationLoading && (
                  <div className="rounded-3xl border border-white/10 bg-[#0b0d14] p-8 sm:p-12 text-center">
                    <Loader
                      size={40}
              ...
              <>
                <div className="rounded-3xl border border-[#5A2680]/30 bg-[#0b0d14] p-5 sm:p-8">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                      <p className="text-sm font-semibold tracking-wider text-[#c084fc]">
                        AI VALUATION COMPLETE
                      </p>

                      <h2 className="mt-2 text-2xl sm:text-4xl font-black break-words">
                        {valuationResult.address}
                      </h2>
                    </div>

                    <div className="w-fit rounded-lg bg-green-500/20 px-3 py-1 text-sm font-semibold text-green-400">
                      ✓ 94% Confidence
                    </div>
                  </div>
                  ...
                  <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
                    <div>
                      ...
                      <p className="mt-2 text-3xl sm:text-4xl font-black text-[#d8b4fe]">
                        {valuationResult.estimatedValue}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-3xl sm:text-4xl font-black text-green-400">
                        {valuationResult.yoyGrowth}
                      </p>
                    </div>
                    ...
                    {valuationResult.comparables.map(
                      (comp: any, idx: number) => (
                        ...
                        >
                          ...
                          <p className="text-2xl font-bold text-[#d8b4fe]">
                            {comp.price}
                          </p>
                        </div>
                      )
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-6 py-3 font-semibold transition hover:bg-white/10"
                >
                  Value Another Property
                </button>
              </>
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-3xl border border-white/10 bg-[#0b0d14] p-5 sm:p-8">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="w-fit rounded-full bg-green-500/20 px-3 py-1 text-sm font-semibold text-green-400">
                  ● Live Data
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
                <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
                  ...
                  <p className="mt-2 text-3xl font-black text-[#d8b4fe]">
                    {marketData[selectedRegion].avgPrice}
                  </p>
                </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0b0d14] p-5 sm:p-8">
              ...
              <div className="mt-6 flex h-52 sm:h-72 items-end justify-between gap-2">
                {Array.from({ length: 12 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex-1 rounded-lg bg-yellow-700/40"
                    style={{
                      height: `${40 + Math.random() * 40}%`,
                    }}
                  />
        ...
        {activeTab === "scheduler" && (
          <div className="mt-6">
            <div className="rounded-3xl border border-white/10 bg-[#0b0d14] p-5 sm:p-8">
              ...
              <p className="mt-2 text-white/60">
                AI analyses routes, availability, and preferences.
              </p>
              ...
              {selectedProperty && (
                <>
                  ...
                  {selectedProperty &&
                    selectedDate &&
                    selectedTime && (
                      <button className="mt-8 w-full rounded-2xl bg-[#5A2680] px-6 py-3 font-bold transition hover:bg-[#6b2f97]">
                        Book Viewing for {selectedTime}
                      </button>
                    )}
                </>
              )}

              <div className="mt-8 rounded-2xl border border-[#5A2680]/30 bg-[#5A2680]/10 p-5 sm:p-6">
                ...
                <ul className="mt-4 space-y-2 text-sm text-white/80">
                  <li>
                    • Saturday mornings have 34% higher
                    conversion rates
                  </li>

                  <li>
                    • Buyer preference suggests afternoon
                    viewings
                  </li>

                  <li>
                    • Multiple buyers requested viewings this
                    week
                  </li>
                </ul>
              </div>
